...
do
    ...
    then
        ...
        TABLE_SQL="select TABLE_NAME from $MIGRATION_STATUS_TABLE where SCHEMA_NAME='$DB' and ERROR='N' and DUMPED='Y' and COMPRESSED='Y' and UPLOADED='Y' and IMPORTING='N' and IMPORTED='N' limit 1"
